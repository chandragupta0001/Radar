...
model = Sequential()
model.add(Conv2D(96,(7,7),activation='elu',input_shape=(32,32,1)))
...
checkpoint_cb=tf.keras.callbacks.ModelCheckpoint("/home/ee/mtech/eet192341/codes/deep_soli/deep_cnn/2_run/cnn_deep_model_2.h5",save_best_only=True)
...
#plt.show()
plt.savefig("/home/ee/mtech/eet192341/codes/deep_soli/deep_cnn/2_run/cnn_deep_loss_acc_curve.png")

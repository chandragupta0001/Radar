...
checkpoint_cb=tf.keras.callbacks.ModelCheckpoint("/home/ee/mtech/eet192341/codes/deep_soli/end_to_end/2_run/model_cnn_lstm.h5",save_best_only=True)
...
history = model.fit(X_train,y_train,verbose=2,batch_size=16, epochs=100,validation_data=(X_val,y_val),callbacks=[checkpoint_cb])

pd.DataFrame(history.history).plot(figsize=(16,10))
plt.grid(True)
plt.gca().set_ylim(0,1)
plt.savefig("/home/ee/mtech/eet192341/codes/deep_soli/end_to_end/2_run/LA_curve_ete.png")
print("finished")

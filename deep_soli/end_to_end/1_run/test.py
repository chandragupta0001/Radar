...
model = tf.keras.models.load_model('/home/ee/mtech/eet192341/codes/deep_soli/end_to_end/1_run/model_cnn_lstm.h5')
model.summary()
...
plt.savefig("/home/ee/mtech/eet192341/codes/deep_soli/end_to_end/1_run/confusion.png")
